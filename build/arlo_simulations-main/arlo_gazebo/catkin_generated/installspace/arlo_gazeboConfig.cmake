...
if(arlo_gazebo_CONFIG_INCLUDED)
  return()
endif()
set(arlo_gazebo_CONFIG_INCLUDED TRUE)
...
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'arlo_gazebo' is deprecated")
...
if(NOT "include;/usr/include;/usr/include/gazebo-9;/usr/include/bullet;/usr/include/simbody;/usr/include/sdformat-6.0;/usr/include/ignition/math4;/usr/include/OGRE;/usr/include/OGRE/Terrain;/usr/include/OGRE/Paging;/usr/include/ignition/transport4;/usr/include/ignition/msgs1;/usr/include/ignition/common1;/usr/include/ignition/fuel_tools1 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${arlo_gazebo_DIR}/../../../include" ABSOLUTE)
      ...
      message(FATAL_ERROR "Project 'arlo_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND arlo_gazebo_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND arlo_gazebo_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT arlo_gazebo_NUM_DUMMY_TARGETS)
      set(arlo_gazebo_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::arlo_gazebo::wrapped-linker-option${arlo_gazebo_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR arlo_gazebo_NUM_DUMMY_TARGETS "${arlo_gazebo_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::arlo_gazebo::wrapped-linker-option${arlo_gazebo_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND arlo_gazebo_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(arlo_gazebo_LIBRARY_DIRS ${lib_path})
      list(APPEND arlo_gazebo_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'arlo_gazebo'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND arlo_gazebo_LIBRARIES ${lib})
    endif()
  endif()
...
set(arlo_gazebo_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${arlo_gazebo_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "roscpp;std_msgs;sensor_msgs;geometry_msgs;nav_msgs;tf;gazebo_ros;message_generation")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 arlo_gazebo_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${arlo_gazebo_dep}_FOUND)
      find_package(${arlo_gazebo_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${arlo_gazebo_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(arlo_gazebo_INCLUDE_DIRS ${${arlo_gazebo_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(arlo_gazebo_LIBRARIES ${arlo_gazebo_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${arlo_gazebo_dep}_LIBRARIES})
  _list_append_deduplicate(arlo_gazebo_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(arlo_gazebo_LIBRARIES ${arlo_gazebo_LIBRARIES})

  _list_append_unique(arlo_gazebo_LIBRARY_DIRS ${${arlo_gazebo_dep}_LIBRARY_DIRS})
  list(APPEND arlo_gazebo_EXPORTED_TARGETS ${${arlo_gazebo_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${arlo_gazebo_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
